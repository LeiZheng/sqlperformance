...
class RowPublisherOperation<T>  extends RowBaseOperation<T> 
  ...
  static final Subscriber<? super Result.RowColumn> DEFAULT_SUBSCRIBER = new Subscriber<Result.RowColumn>() {
  ...
  @Override
  public ParameterizedRowPublisherOperation<T> subscribe(Subscriber<? super Result.RowColumn> s,
                                                         CompletionStage<? extends T> result) {
