 ...
 * source that meets the specifications set by the {@link Builder} can
...
public interface Session extends AutoCloseable, OperationGroup<Object, Object> {
 ...
 public enum Lifecycle {
   ...
   * {@link Lifecycle#NEW} lifecycle state. It transitions to
   * {@link Lifecycle#CLOSED} if initialization fails.
   *
   */
   ...
   * either by the {@link DataSource} or the {@link Builder} are not
   * included.
   *
